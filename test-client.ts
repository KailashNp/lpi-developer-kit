...
async function main() {
  ...
  const tests: Array<{ name: string; args: Record<string, string> }> = [
    ...
    { name: "query_knowledge", args: { query: "A".repeat(10000) as any } },
    { name: "query_knowledge", args: { query: "!@#$%^&*()_+{}[]<>?/\\|" as any } },
    { name: "query_knowledge", args: { query: "' OR 1=1 --" as any } },
    { name: "query_knowledge", args: { query: "" } },
    { name: "query_knowledge", args: { query: null as any } },
    { name: "query_knowledge", args: { query: 12345 as any } },
    { name: "get_case_studies", args: {} },
    { name: "get_case_studies", args: { query: 12345 as any } },
    { name: "get_case_studies", args: { query: "" } },
